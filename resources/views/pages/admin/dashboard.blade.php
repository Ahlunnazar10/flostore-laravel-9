    ...
    <div class="section-content section-dashboard-home" data-aos="fade-up">
        <div class="container-fluid">
            <div class="dashboard-heading">
                ...
                <p class="dashboard-subtitle">This is Flostore Administrator Panel!</p>
            </div>
                        ...
                        <a href="/dashboard-transaction-details.html" class="card card-list d-block">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">Ahlun Nazar</div>
                        ...
                        <a href="/dashboard-transaction-details.html" class="card card-list d-block">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">Dea Caesaria F P</div>
                                    <div class="col-md-3">11 Januari, 2022</div>
                                    <div class="col-md-1 d-none d-md-block">
                                        <img src="/images/dashboard-arrow-right.svg" alt="" />
                                    </div>
                                </div>
                        ...
                        <a href="/dashboard-transaction-details.html" class="card card-list d-block">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">M Fauzi D P</div>
                                    <div class="col-md-3">10 Januari, 2022</div>
                                    <div class="col-md-1 d-none d-md-block">
                                        <img src="/images/dashboard-arrow-right.svg" alt="" />
                                    </div>
                                </div>
